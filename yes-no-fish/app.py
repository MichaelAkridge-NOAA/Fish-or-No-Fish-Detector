# Yes-Fish / No-Fish – Pygame + YOLO11  (v 3.3)
# =============================================================================
# https://pypi.org/project/pygame/
#
# pip install pygame ultralytics
# -----------------------------------------------------------------------------
...
@dataclass
class Config:
    IMAGE_DIR        = "./images/fish"
    MODEL_PATH       = "./model/yolov11n_fish_trained.pt"
    LEADERBOARD_FILE = "./leaderboard.json"
    LOGO_PATH        = os.path.join("assets", "logo.png")
    SND_CORRECT      = os.path.join("assets", "correct.wav")
    SND_WRONG        = os.path.join("assets", "wrong.wav")
